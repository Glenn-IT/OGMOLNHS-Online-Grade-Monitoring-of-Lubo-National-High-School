...
> [!NOTE]
> This is the official copy of [SYSTEM-MEMORY.md](file:///C:/xampp/htdocs/OGMS-Lubo-National-High-School/SYSTEM-MEMORY.md) located inside the `docs/` repository directory.
